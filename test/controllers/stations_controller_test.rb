...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { station_name: @station.station_name, station_number: @station.station_number } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { station_name: @station.station_name, station_number: @station.station_number } }
